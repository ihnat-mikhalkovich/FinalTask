...
public class EditTariffSaveCommand implements Command {
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ExtendedRoomTariff tariff = new ExtendedRoomTariff(tariffId, cost, visibility, names, descriptions);
        ServiceFactory factory = ServiceFactory.getInstance();
        RoomService roomService = factory.getRoomService();
        try {
            roomService.editTariff(tariff);
