...
<head>
    ...
    <title><fmt:message key="adding_a_tariff" bundle="${ bundle }" /></title>
    <meta charset="utf-8">
...
<nav class="navbar navbar-inverse">
    <div class="container">
        ...
        <c:set var="currentPage" value="/FrontController?commandType=add_tariff_form" />
...
<div class="container">
    <div class="jumbotron">
        <p class="text-center"><fmt:message key="adding_a_tariff" bundle="${ bundle }" /></p>
    </div>
    <c:set var="languageEnum" scope="page" value="${ requestScope.languageEnum }" />
    <form action="/FrontController" method="post">
        <div class="input-group">
            <input type="hidden" name="commandType" value="add_tariff_save">
            ...
            <ul class="list-group">
                ...
                <li>
                    <div class="input-group sign-up-text">
                        ...
                        <input type="text" name="cost" id="tariffCost" class="form-control">
                    </div>
                </li>
                <li>
                    <div class="input-group sign-up-text">
