...
<c:set var="pageNumber" value="${ requestScope.applicationPage.currentPage }" />
<c:set var="currentPage" value="/FrontController?commandType=orders&page=${ pageNumber }" />
...
<c:set var="applicationItems" value="${ requestScope.applicationPage.roomHistory }" scope="page" />

<div class="container">
    <div class="jumbotron">
        <h2 class="text-center"><fmt:message key="orders" bundle="${ bundle }" /></h2>
    </div>
    <div class="offers">
        <table>
            <tbody>
                <c:forEach var="elem" items="${ applicationItems }" varStatus="status">
                    ...
                    <tr>
                        ...
                        <td>
                            <ul class="list-group">
                                ...
                                <li class="list-group-item"><fmt:message key="rooms_amount" bundle="${ bundle }" />: ${ reservedRoom.roomsAmount }</li>
                                ...
                                <li class="list-group-item"><fmt:message key="user_id" bundle="${ bundle }" />: ${ reservedRoom.userId } </li>
                                ...
                                <li class="list-group-item pull-right">
                                    <form action="/FrontController" method="post">
                                        <input type="hidden" name="commandType" value="allow_order" />
                                        <input type="hidden" name="transaction_id" value="${ reservedRoom.reservedRoomId }" />
                                        <input type="hidden" name="page" value="${ pageNumber }" />
                                        <input type="submit" value="<fmt:message key="allow" bundle="${ bundle }" />" class="btn btn-warning" />
                                    </form>
                                </li>
                            </ul>
                        </td>
...
<c:set var="pageAmount" value="${ applicationPage.pageAmount }" scope="page" />
...
<script type="text/javascript">
    executeOrdersPagination(${ pageNumber }, ${ pageAmount });
</script>
