...
<c:set var="userId" value="${ requestScope.userId }" scope="page" />
<c:set var="pageNumber" value="${ requestScope.history.currentPage }" scope="page" />
<c:set var="currentPage" value="/FrontController?commandType=userHistory&user_id=${ userId }&page=${ pageNumber }" />
...
<div class="container">
    <div class="jumbotron">
        <h2 class="text-center"><fmt:message key="user_history" bundle="${ bundle }" />: id= ${ userId }</h2>
    </div>
    <div class="offers">
        <table>
...
<script type="text/javascript">
    executeUserHistoryPagination(${ pageNumber }, ${ pageAmount }, ${ userId });
</script>
