...
<div class="container">
  ...
  <table class="table table-condensed table-hover">
    <form action="/FrontController" method="post" name="changePasswordForm" onsubmit="return changePassword()">
      <tbody>
        <input type="hidden" name="commandType" value="change_password_save" />
        <tr>
            <td class="col-sm-3"><label for="password" id="passwordLabel"><fmt:message key="password" bundle="${ bundle }" />:</label></td>
          <td>
            <input type="password" name="password" class="form-control" id="password" />
          </td>
        </tr>
        <tr>
          <td><label for="new_password" id="new_passwordLabel"><fmt:message key="new_password" bundle="${ bundle }" />:</label></td>
          <td>
